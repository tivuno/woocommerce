...
var Choice = function Choice(_ref) {
  ...
  }, title)), selected && subOptionsComponent && (0,react.createElement)("div", {
...
var renderMenu = function renderMenu(_ref) {
  ...
  return function (_ref2) {
    ...
    }, items.map(function (item, menuIndex) {
...
var MultipleSelector = function MultipleSelector(_ref) {
  ...
  return (0,react.createElement)(experimental_select_control_select_control/* SelectControl */.Y, {
...
var UserProfile = function UserProfile(_ref) {
  ...
  var renderAlreadySellingOptions = function renderAlreadySellingOptions() {
    ...
    }, (0,build_module.__)('Are you selling online?', 'woocommerce')), (0,react.createElement)(select_control/* default */.A, {
    ...
    })), sellingOnlineAnswer && ['yes_im_selling_online', 'im_selling_both_online_and_offline'].includes(sellingOnlineAnswer) && (0,react.createElement)("div", {
      className: "woocommerce-profiler-selling-platform"
    }, (0,react.createElement)("p", {
      className: "woocommerce-profiler-question-label"
    }, (0,build_module.__)('Which platform(s) are you currently using?', 'woocommerce')), (0,react.createElement)(MultipleSelector, {
  ...
  }, (0,build_module.__)('Which one of these best describes you?', 'woocommerce')), businessOptions.map(function (_ref2) {
...
var Basic = function Basic() {
  return (0,react.createElement)(UserProfile, {
