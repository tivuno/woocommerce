...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	protected function get_settings_for_default_section() {
		...
		if ( FeaturesUtil::feature_is_enabled( 'email_improvements' ) ) {
			$email_template_description = sprintf( __( 'Customize your WooCommerce email template and preview it below.', 'woocommerce' ) ) .  sprintf( __( 'This section lets you customize the WooCommerce emails. <a href="%s" target="_blank">Click here to preview your email template</a>.', 'woocommerce' ), wp_nonce_url( admin_url( '?preview_woocommerce_mail=true' ), 'preview-mail' ) );
			$logo_image = array(
